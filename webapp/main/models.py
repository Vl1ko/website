...
class Response(models.Model):
    ...
    gl3_1 = models.CharField(max_length=10000, blank=True, null=True, verbose_name='Глава 3-1')
    gl3_2 = models.CharField(max_length=10000, blank=True, null=True, verbose_name='Глава 3-2')
    gl3_3 = models.CharField(max_length=10000, blank=True, null=True, verbose_name='Глава 3-3')
    gl3_4 = models.CharField(max_length=10000, blank=True, null=True, verbose_name='Глава 3-4')
    gl4_1 = models.CharField(max_length=10000, blank=True, null=True, verbose_name='Глава 4-1')
    gl4_2 = models.CharField(max_length=10000, blank=True, null=True, verbose_name='Глава 4-2')
    gl5_1 = models.CharField(max_length=10000, blank=True, null=True, verbose_name='Глава 5-1')
    gl5_2 = models.CharField(max_length=10000, blank=True, null=True, verbose_name='Глава 5-2')    
